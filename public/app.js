...
const seatPositions = [
  ["50%",  "84%"],  // 1 bottom-centre  (was 88 — pulled in to stay inside rail)
  ["26%",  "78%"],  // 2 bottom-left    (was 80)
  ["9%",   "62%"],  // 3 left lower
  ["9%",   "38%"],  // 4 left upper
  ["26%",  "22%"],  // 5 top-left       (was 20)
  ["50%",  "14%"],  // 6 top-centre     (was 12)
  ["74%",  "22%"],  // 7 top-right
  ["91%",  "38%"],  // 8 right upper
  ["91%",  "62%"],  // 9 right lower
  ["74%",  "78%"],  // 10 bottom-right  (was 80)
];
